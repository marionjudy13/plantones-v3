...
export default function Topnav() {
  return (
    <header class="flex items-center w-full justify-between px-5 pb-5 pt-6 border-b border-black sm:px-10 sm:py-8">
      <div class="flex flex-wrap">
        <Link href="/" class="cursor-pointer">
          <a class="text-4xl font-black uppercase w-full sm:text-6xl sm:mb-1">
            P<span class="font-light">(</span>l<span class="font-light">)</span>
            antones
          </a>
        </Link>
