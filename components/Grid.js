...
export default function Grid({ props }) {
  return (
    <div>
      {props.length > 0 && (
        <div class="relative grid gap-5 grid-cols-2 sm:grid-cols-3 md:grid-cols-4 md:gap-4 lg:grid-cols-5">
          {props.map((plant) => (
            <div
              key={plant._id}
              class="border-solid border border-black aspect-w-1 aspect-h-1 flex items-center justify-center z-10 group overflow-hidden"
            >
